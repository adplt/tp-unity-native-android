...
<nav class="navbar navbar-inverse navbar-fixed-top" role="navigation">
    <div class="container">
        ...
        <div class="navbar-header">
            ...
            <a class="navbar-brand" href="{{url('/home')}}">TP Unity</a>
            ...
            <ul class="nav navbar-nav navbar-right top-nav">
                <li class="dropdown" style="position: relative;">
                    ...
                    <ul class="dropdown-menu">
                        <li><a href="{{url('/tprequest')}}"><i class="glyphicon glyphicon-plus-sign"></i>New TP Request
                            </a></li>
                        <li><a href="{{url('/changePassword')}}"><i class="glyphicon glyphicon-cog"></i> Change Password</a>
                        </li>
