...
<html>
    <head>
        ...
        <title>TPUnity - Google Cloud Messaging</title>
                 ...
                 ?>
                        <td align="left">
                             <form id="<?php echo $rowUsers["id"] ?>" name="" method="post" onSubmit="return sendPushNotification('<?php echo $rowUsers["id"] ?>')">
                                <label><b>Name:</b> </label> <span><?php echo $rowUsers["tp_name"] ?></span>
                                <div class="clear"></div>
                                ...
                                <div class="send_container">                                
                                    ...
                                    <input type="hidden" name="regId" value="<?php echo $rowUsers["gcm_id"] ?>"/>
