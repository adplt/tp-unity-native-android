...
public class AbsenceDetail extends AppCompatActivity implements NavigationView.OnNavigationItemSelectedListener{
    ...
    private TextView tv_nav_menu,tv_1,tv_2,tv_3,tv_4,tv_5;
    ...
    protected void onCreate(Bundle savedInstanceState){
        ...
        pd = new ProgressDialog(AbsenceDetail.this);
        pd.setIndeterminate(true);
        pd.setCancelable(false);
        pd.setMessage("Please wait...");

        sm = new Session(AbsenceDetail.this);
        ...
        if(sm.getStatusLogin() == true){
            ...
            tv_1 = (TextView) findViewById(R.id.start_date_field_absence_detail);
            tv_2 = (TextView) findViewById(R.id.start_time_field_absence_detail);
            tv_3 = (TextView) findViewById(R.id.end_date_field_absence_detail);
            tv_4 = (TextView) findViewById(R.id.end_time_field_absence_detail);
            tv_5 = (TextView) findViewById(R.id.description_absence_detail);
            ...
            tv_5.setText(data.get(Session.AB_DESCRIPTION));
        }else{
            new AlertDialog.Builder(AbsenceDetail.this)
                .setMessage("Your session has expired, please login.")
                .setPositiveButton("Ok", new DialogInterface.OnClickListener() {
                    @Override
                    public void onClick(DialogInterface dialog, int which) {
                        new Logout(AbsenceDetail.this).execute();
                    }
                })
                .show();
        }
    ...
    public void goToProfile(View v){
        ...
        startActivity(new Intent(AbsenceDetail.this, ProfileLogin.class));
    }
    ...
    public void getNavImage(){
        new DisplayImageOptions.Builder()
            ...
            .cacheOnDisk(true)
            .build();
        ImageLoaderConfiguration ilc = new ImageLoaderConfiguration.Builder(AbsenceDetail.this).build();
    ...
    public boolean onOptionsItemSelected(MenuItem item){
        ...
        switch(item.getItemId()){
            case R.id.menu:
                ...
                break;
            case R.id.edit:
                startActivity(new Intent(AbsenceDetail.this,EditAbsence.class));
                break;
        }
    ...
    public boolean onNavigationItemSelected(MenuItem item){
        ...
        if(id == R.id.follow_up_nav_menu){
            new RequestPermission(AbsenceDetail.this).execute("no_prm_login=" + user.get(Session.NO_PRM_LOGIN));
        }else if(id == R.id.input_data_nav_menu){
            startActivity(new Intent(AbsenceDetail.this, InputData.class));
        }else if(id == R.id.view_absence_nav_menu){
            startActivity(new Intent(AbsenceDetail.this, Absence.class));
        }else if(id == R.id.check_schedule_nav_menu){
            startActivity(new Intent(AbsenceDetail.this, Schedule.class));
        }else if(id == R.id.product_nav_menu){
            startActivity(new Intent(AbsenceDetail.this, Product.class));
        }else if(id == R.id.setting_nav_menu){
            startActivity(new Intent(AbsenceDetail.this, Setting.class));
