...
public class AvailableAdapter extends ArrayAdapter<Available> {
    ...
    private List<Available> a_list;
    private LayoutInflater li;

    public AvailableAdapter(Context context, int resource, List<Data.Available> a_list){
    ...
    public View getView(int position, View convertView, ViewGroup parent){
        if(convertView==null){
            ...
            tv_1.setText(a_list.get(position).getStart());
            tv_2.setText(a_list.get(position).getUntil());
        }
